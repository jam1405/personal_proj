#This file controls the visualization aspect of the simulation
import numpy as np
import sys
import os
...
#### Simulation inputs
rowpts=FlowPy_Input.rowpts
colpts=FlowPy_Input.colpts
length=FlowPy_Input.length
breadth=FlowPy_Input.breadth
